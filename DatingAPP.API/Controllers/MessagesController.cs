...
namespace DatingAPP.API.Controllers
{
    ...
    public MessagesController(IDatingRepository repo, IMapper mapper, IHubContext<MessageHub> hubContext)
    {
    ...
    public async Task<IActionResult> CreateMessage(int userId, MessageForCreationDto messageForCreationDto)
    {
        ...
        if (await _repo.SaveAll())
        {
            ...
            return CreatedAtRoute(nameof(GetMessage), new { id = message.Id }, messageToReturn); //OVDE JE GRESKA MORA SE PROVERITI
